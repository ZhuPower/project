  ...
  <div class="footMain">
    ...
    <div class="address">
      <div class="address-box address-box-1">
        ...
        <p>5F 35 Xiaoyun Road<br/>Chaoyang District Beijing 100028</p>
      </div>
      <div class="address-box address-box-2">
        <div class="address-name">Shanghai</div>
        <p>702&703 Block T5, Crystal Plaza Pudong<br/> New Area Shanghai 200002</p>
      </div>
      <div class="address-box address-box-3">
        <div class="address-name">Guangzhou</div>
        <p>2F Bolangnu Building West Tower Tianhe<br/> Software Park 59 Jianzhong Road<br/> Guangzhou 510665
        </p>
      </div>
    </div>

    <div class="foot-left">
      <img src="../assets/txt2.png" class="mzkj" />
      <div class="copyright"><span style="font-family:Faktum-Regular;">@ 2020 Grotech </span>版权所有 </div>
    </div>
...
<style scoped>
  ...
  .address-box-1 .address-name {
    margin-bottom: calc(12vw/3.75);
  }

  .address-box-2 .address-name {
    margin-bottom: calc(12vw/3.75);
  }
</style>