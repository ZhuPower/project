let oData2 = {
  bannerVideo: {
    src: '',
    p1: 'Utilizing cutting-edge Grotech® big data and AI <br/>technology, Grotech provides in-depth analysis<br/> focused on industries and consumers'
  },
  proMain: [
    {
  ...
  visionValue: {
    ...
    list: [
      {
        h1: 'Vision',
        h2: 'Company<br/>Vision',
        p2: 'To create more, and let more people own the products that deliver “Happiness”.'
      },
      {
        h1: 'Value',
        h2: 'The definition of<br/>“Happiness”',
        p2: 'Fulfilling consumer needs<br/>Sustainable<br/>Having excellent business ethics'
      }
    ]
  }
}
